...
package com.premium.alarm.view;
...
import com.premium.alarm.view.VolumePreference.SeekBarVolumizer;
...
public class VolumePreference extends DialogPreference implements View.OnKeyListener, IVolumizerMaster {
    ...
    private void createActionButtons(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.com_premium_alarm_view_VolumePreference, 0, 0);
        boolean cancelButtonUsed = a.getBoolean(R.styleable.com_premium_alarm_view_VolumePreference_cancelButton, true);
